...
public class DepositMethodTest {
	...
	public void setUp() throws AccountException, ClientException, BankException {
		...
		Client client = new Client(bank, new ClientPersonalInfo("José", "Manuel", "123456789", 33), "987654321",
				"Street");
		Client youngclient = new Client(bank, new ClientPersonalInfo("José", "Manuel", "123456780", 17), "987654321",
				"Street");
