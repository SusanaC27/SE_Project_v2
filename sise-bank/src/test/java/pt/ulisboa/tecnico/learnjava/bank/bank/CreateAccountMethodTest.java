...
public class CreateAccountMethodTest {
	...
	public void setUp() throws BankException, ClientException {
		...
		this.client = new Client(this.bank, new ClientPersonalInfo("José", "Manuel", "123456789", 33), "987654321",
				"Street");
		;
	}
	...
	public void successYoungAccount() throws BankException, AccountException, ClientException {
		Client youngClient = new Client(this.bank, new ClientPersonalInfo("José", "Manuel", "123456780", 16),
				"987654321", "Street");
	...
	public void failYoungAccountMoreThan17() throws BankException, AccountException, ClientException {
		Client notSoYoungClient = new Client(this.bank, new ClientPersonalInfo("José", "Manuel", "123456780", 18),
				"987654321", "Street");
