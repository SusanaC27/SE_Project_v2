...
public class ExamTests {
	...
	public void setUp() throws AccountException, ClientException, BankException {
		...
		this.client = new Client(this.bank, new ClientPersonalInfo("José", "Manuel", "123456789", 33), "987654321",
				"Street");
		Client otherClient = new Client(this.bank, new ClientPersonalInfo("José", "Manuel", "023456789", 33),
				"987654321", "Street");
		this.youngClient = new Client(this.bank, new ClientPersonalInfo("José", "Manuel", "123456780", 17),
				"987654321", "Street");
