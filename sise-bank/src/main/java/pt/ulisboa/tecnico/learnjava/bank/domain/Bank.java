...
public class Bank {
	...
	public Client getClientByNif(String nif) {
		return this.clients.stream().filter(c -> c.getClientPersonalInfo().getNif().equals(nif)).findFirst()
				.orElse(null);
	}
	...
	public static void main(String[] args) throws BankException, AccountException, ClientException {
		...
		Client clientOne = new Client(cgd, new ClientPersonalInfo("José", "Manuel", "123456789", 34), "987654321",
				"Street");
		Client clientTwo = new Client(cgd, new ClientPersonalInfo("José", "Manuel", "123456789", 34), "987654321",
				"Street");
